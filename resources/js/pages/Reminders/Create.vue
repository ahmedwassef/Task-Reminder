...
const form = useForm({
    ...
    due_date: null as string | Date | null,
    priority: 'medium',
    frequency_type: 'once',
    frequency_value: null as any,
    advance_notice_days: props.defaultSettings.advance_notice,
    notify_email: props.defaultSettings.notify_email,
    notify_sms: props.defaultSettings.notify_sms,
    notify_whatsapp: props.defaultSettings.notify_whatsapp,
});
...
<template>
    <Head title="إنشاء تذكير جديد" />

    <AppLayout>
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6">
            <div class="flex items-center justify-between">
                <h1 class="text-3xl font-bold">إنشاء تذكير جديد</h1>
                ...
                <Card>
                    ...
                    <CardContent class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            type='date'
                                id="due_date"
                               class="flex   w-full rounded-md border border-input bg-background     disabled:cursor-not-allowed disabled:opacity-50"
